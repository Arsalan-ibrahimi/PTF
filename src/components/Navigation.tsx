...
function openCodepen() {
  window.open('https://codepen.io/Arsalan-Ibrahimi', '_blank');
}

function openGithub() {
  window.open('https://github.com/Arsalan-ibrahimi', '_blank');
}

function sendMail()
{
  window.open('mailto:arsalanibrahimi850@gmail.com', '_blank');

}

function openLinkedin(){
  window.open('https://www.linkedin.com/in/arsalan-ibrahimi-892b5030b/', '_blank');
}

function openinstagram()
{
    window.open('https://www.instagram.com/knigh_.t/', '_blank');
}
  ...
  useEffect(() => {
    ...
    return(
      ...
      <div className='flex w-[100dvw] z-10  position-sticky top-1 border-b-[1px] justify-between items-center  bg-white text-black  nav-stick pl-2 '>
       ...
       <Button type="primary" className='mobile-hide bg-[#24292e] hover:bg-[#2b3137]' onClick={openGithub} icon={<GithubOutlined />} iconPosition='end'>
          My GitHub
          </Button>
          <Button type="default" className='mobile-hide border-[#24292e] hover:bg-[#2b3137]' icon={<CodepenOutlined />} onClick={openCodepen} iconPosition='end'>
          </Button>
