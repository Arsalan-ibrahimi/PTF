...
{
  return(
    <footer className='w-full h-[10dvh] flex justify-between footer  pt-5 px-3 '>
      <div className='detail-container w-[33%]'>
        ...
        <p className='text-[1.02dvw] text-[#333237] font-[Lato] font-bold'>ARSALAN IBRAHIMI</p>
        </div>
        
      </div>
      <div className='w-[33%] text-center text-[11px]'>Copyright © 2012 - 2024 TermsFeed®. All rights reserved.</div>
      <div className='w-[33%] text-end text-[11px]'>
